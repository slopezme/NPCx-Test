...
t_sim = 10;
n_frames = 100; %<- numero de frames de la pelicula
t = linspace(0,t_sim,n_frames);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Definimos la trayectoria del eslabón
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Definición del giro del primer eslabón
q1i = 180*pi/180; qlf = 135*pi/180;
q1  = linspace(q1i,qlf,n_frames);
%Definición del giro del segundo eslabón
q2i = 0*pi/180; q2f = -90*pi/180;
q2  = linspace(q2i,q2f,n_frames);
%Definición del giro del tercer eslabón
q3i = 0*pi/180; q3f = -90*pi/180;
